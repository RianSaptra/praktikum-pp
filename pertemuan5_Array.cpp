...
int main(){
    ...
    string hari[7] = {"Senin", "Selasa", "Rabu", "Jumat", "Sabtu", "Minggu"};
    ...
    int panjang = sizeof(hari[1]) / sizeof(hari[0]);
    ...
    cout << "Kedai chicken katsu buka selama : " << jumlahbaris << "bulan ditanggal tertentu." << endl;
